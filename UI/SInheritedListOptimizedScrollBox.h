...
/** Fixed-extent virtualized list implemented directly on top of SScrollBox. */
class SInheritedListOptimizedScrollBox : public SScrollBox
{
public:
	DECLARE_DELEGATE_TwoParams(FOnVisibleRangeChanged, int32, int32);

	SLATE_BEGIN_ARGS(SInheritedListOptimizedScrollBox)
...
private:
	...
	EOrientation ListOrientation = Orient_Vertical;
